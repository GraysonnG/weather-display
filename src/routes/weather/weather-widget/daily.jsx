...
const getUVFillColor = (index) => {
    ...
    if (index <= 2) return colors[0]
    if (index <= 5) return colors[1]
    if (index <= 7) return colors[2]
    if (index <= 10) return colors[3]
    return colors[4]
}

const getUVRating = (index) => {
    if (index <= 2) return "Lo"
    if (index <= 5) return "Mo"
    if (index <= 7) return "Hi"
    if (index <= 10) return "VH"
    return "Ex"
}
